...
const ProjectData = [
    {
        imgsrc: ecom,
        title: "Ecommmece MERN Stack App",
    ...
    },
    {
        ...
        text: " A complete ecommerce website developed using Django Framework with many functionalities using PayPal API for payment for users and guest users. User registration, login, and reset password with activation link send to your email.This app is developed using Python for backend, Postgres database, and JavaScript, HTML and CSS for frontend",
        view: "https://www.youtube.com/watch?v=BDiIiLXCb7I",
        source: "https://github.com/Akoatem/MVP.git"
    },

    {
        imgsrc: booking,
        title: "Hotels airBnB MERN Stack App",
    ...
    {
        imgsrc: meal,
        title: "Food Search Rest API app",
      ...
      {
        imgsrc: admin,
        title: "Admin Dashboard Frontend App ",
        text: "An admin dashboard application built from scratch in react JS which can be easily integrated to the backend, mongoDB and client side and can be used to create users, products and show analytics, saleS and others. Using frontend language javascript, html and css and material UI in react framework.",
    ...
    {
        imgsrc: gpt3,
        title: "GPT3-Frontend App",
        text: "This is fully responsive and mobile friendly web application call GPT3 built from scratch using material-UI, figma, modern UX and UI in react. This web application can be used for a blog, portfolio and other services. A complete frontend app using JavaScript, HTML, CSS, bootstrap and deployed in render.com",
